...
import com.ecom.dto.ForgotPasswordRequest;
...
import com.ecom.dto.ResetPasswordRequest;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<UserResponse>> register(
        ...
        // ✅ FIXED: Use findByName instead of findByRoleName
    ...
    private UserResponse mapToUserResponse(User user) {
        ...
        List<String> roleNames = user.getRoles().stream()
                .map(role -> role.getName())  // Use getName() method
...
public ResponseEntity<ApiResponse<String>> forgotPassword(
    ...
    user.generateResetToken(resetToken, 60); // 60 minutes expiry
    userRepository.save(user);
